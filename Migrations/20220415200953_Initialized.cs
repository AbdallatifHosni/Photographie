        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailAdress = table.Column<string>(name: "Email-Adress", type: "Varchar(35)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientPhotographer", x => new { x.ClientId, x.PhotographerId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClientPhotographer_Photographer_PhotographerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Client_WorkId",
                table: "Client",
                column: "WorkId");

            migrationBuilder.CreateIndex(
                name: "IX_ClientPhotographer_PhotographerId",
